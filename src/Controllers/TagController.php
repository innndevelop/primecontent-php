...
class TagController extends BaseController
{
    ...
    public function getAll(array $arguments = [])
    {
        ...
        $uri = "spaces/{$this->config->getSpaceId()}/tags{$queryParams}";
     ...
     * @throws NotInitializedException
     */
    public function getOne(string $tagId)
    {
        if (!$this->config->isInitialized()) {
            throw new NotInitializedException();
        }

        $uri = "spaces/{$this->config->getSpaceId()}/tags/{$tagId}";
     ...
     * @throws NotInitializedException
     */
    public function update(string $tagId, $data)
    {
        if (!$this->config->isInitialized()) {
            throw new NotInitializedException();
        }
    ...
    public function create($data)
    {
        ...
        $uri = "spaces/{$this->config->getSpaceId()}/tags";
