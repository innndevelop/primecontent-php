...
class AssetController extends BaseController
{
    ...
    public function getAll(array $arguments = [])
    {
        ...
        $uri = "spaces/{$this->config->getSpaceId()}/assets{$queryParams}";
     ...
     * @throws NotInitializedException
     */
    public function getOne(string $assetId)
    {
        if (!$this->config->isInitialized()) {
            throw new NotInitializedException();
        }

        $uri = "spaces/{$this->config->getSpaceId()}/assets/{$assetId}";
     ...
     * @throws NotInitializedException
     */
    public function update(string $assetId, $data)
    {
        if (!$this->config->isInitialized()) {
            throw new NotInitializedException();
        }
    ...
    public function create($data)
    {
        ...
        $uri = "spaces/{$this->config->getSpaceId()}/assets";
